...
const inputClass =
  'w-full rounded-xl border border-gray-300 px-4 py-2.5 text-base text-gray-900 outline-none transition-shadow focus:ring-2 focus:ring-emerald-500'
...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center bg-gradient-to-b from-emerald-50/80 to-gray-50 px-4 py-10">
      ...
      <div className="w-full max-w-md rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
        <h1 className="mb-1 text-center text-2xl font-semibold text-gray-900">Đăng nhập</h1>
        <p className="mb-8 text-center text-sm text-gray-500">Quản lý trả góp nông sản</p>
